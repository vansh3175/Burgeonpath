...
const Payment = () => {
  ...
  const handlePayment = async () => {
    try {
      ...
      const orderResponse = await fetch(`${import.meta.env.VITE_API_URL}/api/v1/payment/create-order`, {
        method: "POST",
      ...
      const options = {
        ...
        handler: async function (response) {
          ...
          const verifyRes = await fetch(`${import.meta.env.VITE_API_URL}/api/v1/payment/verify-payment`, {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
